...
public class WorkMaskAsImportant extends Worker {
    private NoteDao noteDao;
    public WorkMaskAsImportant(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        boolean isImportant=data.getBoolean(ViewModelNote.PRAM2,false);
        try{
            noteDao.markAsImportant(noteid,isImportant);
